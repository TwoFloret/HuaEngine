...
public class TabComplete {
    ...
    static {
        tabListMap.put("huaengine", Arrays.asList("customtitle", "help", "reload", "version", "locktime", "cmdgroup", "var"));
        tabListMap.put("huaengine.customtitle", Arrays.asList("set", "modify"));
        tabListMap.put("huaengine.locktime", Arrays.asList("5000", "10000", "18000"));
        tabListMap.put("huaengine.var", Arrays.asList("add", "set", "remove", "countdown", "timing", "stop"));
    }
